...
wdir = "/media/christof/data/repos/cligs/theatreclassique-private/"
inpath = "tei5_2017-02/*.xml"
metadatafile = "metadata856"
mode = "tc"
...
def get_metadata(wdir, inpath, metadatafile, mode):
    ...
    labels_p4 = ["idno", "tcid"]
    labels_tc = ["idno", "author-short", "title-short", "year-print", "year-performance", "supergenre", "genre", "structure", "form"]
    labels_obl = ["idno","author-name", "title", "year", "supergenre", "genre", "form"]
    ...
    xpaths = {
              "tcid": '//tei:idno//text()',
              "title-short": '//tei:title[@type="short"]//text()',
              "author-short": '//tei:author//tei:name[@type="short"]//text()',
              ...
              "year-performance":'//tei:bibl[@type="performance-first"]//tei:date//text()',
              "year-print":'//tei:bibl[@type="edition-first"]//tei:date//text()',
              "supergenre":'//tei:term[@type="supergenre"]//text()',
              "genre": '//tei:term[@type="genre"]//text()',
              "form": '//tei:term[@type="form"]//text()',
              "structure": '//tei:term[@type="structure"]//text()',
    ...
    for file in glob.glob(wdir + inpath):
        ...
        idno_file = os.path.basename(file)[0:6]
        #idno_header = xml.xpath(xpaths["idno"], namespaces=namespaces)
    ...
    metadata["decade"] = metadata["year-performance"].map(lambda x: str(x)[:-1]+"0s")
